...
/**
 * Use the maven test harness to test the obvious plugin functionality.
 */
public class HbaseStartMojoTest{
    @Rule
    ...
    public void testMojoGoal() throws Exception {
        ...
        final StartMojo mojo = (StartMojo) rule.lookupMojo("start", pom);
